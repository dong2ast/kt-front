        ...
        <div class="info-section">
          <div v-if="!isEditing">
            ...
            <div class="info-row">
              ...
              <span class="value">{{ profile.startDate }} ~ {{ profile.endDate }}</span>
            </div>
            <div class="info-row">
          ...
          <form v-else @submit.prevent="saveProfile" class="edit-form">
            ...
            <div class="form-group">
              ...
              <input v-model.number="editedProfile.hourlyRate" type="number" required min="0">
            </div>
  ...
  setup() {
    ...
    const fetchProfile = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:8080/api/v1/sitters/profile", {
          headers: {
    ...
    const cancelRegistration = () => {
      if (confirm('정말로 펫시터 등록을 취소하시겠습니까?')) {
        console.log('펫시터 등록 취소');
      }
    };
