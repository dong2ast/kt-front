<template>
    <div class="pet-sitter-container">
      ...
      Im Pet
        ...
        <router-link to="/detail" class="user-icon" @click.prevent="fetchUserInfo">USER</router-link>
      </header>
      ...
      <main class="main-content">
        ...
        <div class="control-buttons">
          <template v-if="isPetSitter">
            ...
            <button 
              @click="navigateToServiceRegistration"
              class="square-button"
            >
              서비스 등록
            </button>
  ...
  export default {
    setup() {
      ...
      const sitterServices = ref([
        {
          ...
          name: "강아지 산책",
          price: 25000,
          image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Group%2023-GU4lkUGhAgTLgfItZi61xbUCPy6THy.png"
        },
        {
          id: 2,
          name: "방문 돌봄",
      ...
      try {
        ...
        const response = await axios.get("http://localhost:8080/api/v1/sitters", {
          headers: {
